class Game {
  ...
  getState() {//método que irá ler o gameState do banco de dados
      ...
      gameStateRef.on("value", function(data) {        
        gameState = data.val();//você tinha colocado gameStateRef
    });
  }
  ...
  start() {//método para obter o gameState e então iniciar o jogo
    ...
    this.addSprites(fuels, 4, fullimage, 0.02);
  ...
  play() {
    ...
    this.handleElements();
    //pegar info dos players
    Player.getPlayersInfo();
    //condicional que vai checar se os jogadores entraram no jogo e exibir a
    ...
    //desenhar os sprites
    drawSprites();//faltava o drawSprites
  }
